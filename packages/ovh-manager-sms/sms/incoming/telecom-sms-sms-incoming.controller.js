...
import smsSmsIncomingReadTemplate from './read/telecom-sms-sms-incoming-read.controller';
import smsSmsIncomingReadController from './read/telecom-sms-sms-incoming-read.html';
import smsSmsIncomingRemoveTemplate from './remove/telecom-sms-sms-incoming-remove.controller';
import smsSmsIncomingRemoveController from './remove/telecom-sms-sms-incoming-remove.html';
...
export default class TelecomSmsSmsIncomingCtrl {
  ...
  read(incomingSms) {
    const modal = this.$uibModal.open({
      animation: true,
      template: smsSmsIncomingReadTemplate,
      controller: smsSmsIncomingReadController,
  ...
  remove(incomingSms) {
    const modal = this.$uibModal.open({
      animation: true,
      template: smsSmsIncomingRemoveTemplate,
      controller: smsSmsIncomingRemoveController,
