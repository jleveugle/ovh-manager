...
import smsSendersBlacklistedRemoveTemplate from './remove/telecom-sms-senders-blacklisted-remove.html';
import smsSendersBlacklistedRemoveController from './remove/telecom-sms-senders-blacklisted-remove.controller';
...
export default class TelecomSmsSendersBlacklistedCtrl {
  ...
  remove(blacklist) {
    const modal = this.$uibModal.open({
      animation: true,
      template: smsSendersBlacklistedRemoveTemplate,
      controller: smsSendersBlacklistedRemoveController,
